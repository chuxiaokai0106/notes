...
var input_placeholder = "文章、资源、课程";
if (is_bloger()) {
...
// 因为 logo 是SVG 的，所以必须把 iconfont.js 加入到代码里面
  ...
  document.write('<script class="toolbar-s" type="text/javascript" src='+protocol+'//csdnimg.cn/cdn/content-toolbar/iconfont.js?_=2345"></script>');
  ...
  var tpl ='\<div id="csdn-toolbar" class="csdn-toolbar tb_disnone '+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix" id="nav-left-menu">\
            ...
            <li><a href="https://www.csdn.net/app/" title="APP" target="_blank">APP</a></li>\
            <li><a href="//ask.csdn.net" title="问答" target="_blank">问答</a></li>\
            <li><a href="//mall.csdn.net" title="商城" target="_blank">商城</a></li>\
            <li><a href="//download.csdn.net/vip_code" title="VIP" target="_blank">VIP</a></li>\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="gitChat"><a class="" href="//gitbook.cn/new/gitchat/activity?utm_source=csdnblog1" target="_blank"><svg class="toolbar-icon" aria-hidden="true"><use xlink:href="#gitchat"></use></svg><span>发Chat</span></a></li>\
  ...
  (function() {
    ...
    for(var i=0;i<myNav.length;i++){
        var aurl=myNav[i].getAttribute("href");
          ...
          if(currenturl === '//download.csdn.net/'){
