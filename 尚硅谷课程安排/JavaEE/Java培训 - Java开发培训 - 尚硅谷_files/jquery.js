...
;(function($, window, document, undefined){
    ...
    navScrollSpy.prototype = {
        ...
        fixNav: function(){
            ...
            var fixValue = this.options.oldTop + $('.kc-c').offset().top +100;

            var l = ($(window).width()-1200)/2;

            var endFixValue = $('.kc-c').offset().top+$('.kc-c').height()-$nav.height()-50;
            
            if(st >= fixValue && st<=endFixValue){
                $nav.css({
                    "position":"fixed",
